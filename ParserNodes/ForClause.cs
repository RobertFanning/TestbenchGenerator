...
namespace VHDLparser.ParserNodes
{
	...
	{
		/// <summary>Initializes a new instance of the <see cref="ForClause"/> class.</summary>
		...
		public ForClause(Variable variable, Expression startValue, Expression endValue, Expression stepSize, ClauseCollection block)
		{
