...
namespace VHDLparser {
	...
	// LexicalAnalyser is utilized for the deconstruction of the input into discrete identifiable tokens.
	public class LexicalAnalyser {
		// Input source to be parsed.
		TextReader fSource;
		// Current token created to store the current token that has been read.
		Token fCurrentToken;
		// Current Character being processed by LexicalAnalyser.
		char fCurrentChar;
		...
		public LexicalAnalyser (TextReader source) {
